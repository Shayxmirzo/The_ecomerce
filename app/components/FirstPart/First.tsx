...
function First() {
  return (
    <div className="relative min-h-162.5 bg-[#F2F0F1] overflow-hidden md:min-h-0">
        <div className="absolute inset-x-0 bottom-0 top-68 bg-contain bg-bottom bg-no-repeat md:hidden" style={{ backgroundImage: "url('/Rectangle 2 (1).png')" }} />
        ...
        <div className="container relative mx-auto px-4 py-4 md:px-0 md:py-28 ">
            ...
            <div className="w-full">
                <Link href={"/Filter"} className="w-full px-8 rounded-full bg-black py-3 text-[12px] text-white md:max-w-50 md:py-4 md:text-[18px] hover:bg-[gray] duration-300">Shop Now</Link>
            </div>
            <div className="relative z-10 flex flex-wrap items-center justify-center gap-y-3 text-center md:justify-start md:gap-8 md:text-left">
                <div className="flex w-1/2 flex-col md:w-auto">
                    <h1 className="text-[24px] font-bold md:text-[40px]">{<CountUp end={200} duration={4}/>}+</h1>
                    <p className="text-[9px] text-[gray] md:text-base">International Brands</p>
                </div>
                <div className="hidden h-18.5 w-px bg-[gray] md:block">
                </div>
                <div className="flex w-1/2 flex-col md:w-auto">
                    <h1 className="text-[24px] font-bold md:text-[40px]">{<CountUp end={2000} duration={6}/>}+</h1>
                ...
                <div className="flex w-full flex-col md:w-auto">
                    <h1 className="text-[24px] font-bold md:text-[40px]">{<CountUp end={30000} duration={8}/>}+</h1>
