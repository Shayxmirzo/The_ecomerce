    ...
    <div className="container mx-auto pt-20 pb-0">
      {product ? 
        <div className="flex flex-col gap-7">
            <div className="grid w-full border-b border-[gray] pb-20 items-start gap-10 md:grid-cols-2">
            <div className="relative aspect-4/3 w-full overflow-hidden rounded-2xl bg-[#F0EEED] p-4">
              ...
              <div className="w-full">
                <div className="">
                  <h1 className="line-clamp-1 w-full text-sm font-black md:text-[40px]">{product.title}</h1>
                ...
                <div className="w-full border-b border-[gray] pb-5">
            ...
            <div className="pt-10 flex flex-col gap-3">
                <h1 className="line-clamp-1 w-full text-sm font-black md:text-[48px]">Product details</h1>
                <div className="flex flex-col gap-2">
                    <h1 className="line-clamp-1 w-full text-sm font-black md:text-[40px]">Category type: {product.category}</h1>
                <p className="text-[#00000099] text-[20px] font-medium">{product.description}</p>
                </div>
            </div>
